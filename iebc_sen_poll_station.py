# This script downloads the results for the 47 senators from each of the participation polling station
...
with open("iebc/sen_pollst_" + nowfile, 'w', newline='') as csvfile: # Give optional directory in which to create csv
...
#    with open('in.csv') as csvfile:
    with open('PollingStationCodes.csv') as csvfile:    
        ...
        for row in readCSV:      
            ...
            url_base = "https://public.rts.iebc.or.ke/jsons/round1/results/Kenya_Elections_Senator/1/"
            st_cd1 = "1" + str(st_cd)
