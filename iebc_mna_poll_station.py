...
with open("iebc/mna_pollst_" + nowfile, 'w', newline='') as csvfile: # Give optional directory in which to create csv
...
#    with open('in.csv') as csvfile:
    with open('PollingStationCodes.csv') as csvfile:    
        ...
        for row in readCSV:      
            ...
            url_base = "https://public.rts.iebc.or.ke/jsons/round1/results/Kenya_Elections_Parliamentary/1/"
            st_cd1 = "1" + str(st_cd)
